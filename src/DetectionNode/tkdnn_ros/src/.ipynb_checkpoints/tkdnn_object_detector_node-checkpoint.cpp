...
public:
    TKDNN_DETECTION(): it_(nh_)//构造函数
    {
        ...
        image_sub_2_ =  it_.subscribe("/galaxy_camera_2/image_color",1,&TKDNN_DETECTION::detect_callback, this);
        bbox_pub = nh_.advertise<tkdnn_ros::batchBbox>("/tkDNN_ros/batchBbox", 1);
        bbox_pub_2 = nh_.advertise<tkdnn_ros::batchBbox>("/tkDNN_ros/batchBbox_2", 1);
