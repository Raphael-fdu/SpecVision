...
git clone https://gitee.com/raphael-fdu/opencv.git
git clone https://gitee.com/raphael-fdu/opencv_contrib.git
...
cmake -D CMAKE_BUILD_TYPE=RELEASE \
    ...
    -D OPENCV_EXTRA_MODULES_PATH='~/Softwares/opencv_contrib/modules' \
    -D PYTHON_EXECUTABLE='~/Softwares/opencv4/bin/python' \
    -D BUILD_EXAMPLES=ON \
    -D WITH_CUDA=ON \
...
cd ~/Softwares/opencv4/lib/python3.6/site-packages
