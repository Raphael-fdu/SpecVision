...
then
	# do infer
	ROOT=`dirname $0`
	$ROOT/darknet -i 1 detector test $ROOT/data/droplet_capillary.data $ROOT/cfg/yolov4-tiny-droplet-quaternary.cfg $1 -thresh 0.1 -dont_show -save_labels < /home/chemcello/Desktop/test.txt
else
